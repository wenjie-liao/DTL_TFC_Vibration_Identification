...
#        搭建CNN网络
        self.model.add(Convolution2D(512,2,2, padding='same',input_shape=(shapes[0][0]*5,int((shapes[0][1])/5),3), data_format="channels_last"))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(512,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(MaxPooling2D(pool_size=(2,2), strides=None, padding='valid', data_format="channels_last"))
        self.model.add(Dropout(drop_out))  # Dropout层
        
        self.model.add(Convolution2D(256,2,2, padding='same',input_shape=(80,80,3), data_format="channels_last"))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(256,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(MaxPooling2D(pool_size=(2,2), strides=None, padding='valid', data_format="channels_last"))
        self.model.add(Dropout(drop_out))  # Dropout层
        
        self.model.add(Convolution2D(128,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(128,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(MaxPooling2D(pool_size=(1,1), strides=None, padding='valid', data_format="channels_last"))
        self.model.add(Dropout(drop_out))  # Dropout层
        
        self.model.add(Convolution2D(64,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(64,2,2, padding='same'))
        self.model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001))
...
if __name__ == '__main__':
    ...
    line = shapes[0][0]
    row = (shapes[0][1]-1)
    dropout, batch_size, nb_epoch, steps_per_epoch =  0.5, 4, 128, 64
    test_size = 1024
    model_name="model"
    nb_classes = 2
