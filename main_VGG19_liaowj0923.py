...
#        创建一个贯序模型
        ...
        self.conv_base = VGG19(weights="imagenet",include_top=False,input_shape=(shapes[0][0]*5,int((shapes[0][1])/5),3))
...
if __name__ == '__main__':
    ...
    line = shapes[0][0]
    row = (shapes[0][1]-1)
    dropout, batch_size, nb_epoch, steps_per_epoch =  0.5, 32, 128, 16
    test_size = 1024
    model_name="model"
    nb_classes = 2
